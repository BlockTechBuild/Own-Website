<?php
	...
	require_once('presenters/collections/interpersonal.class.php');
	...
	class Resume
	{
		...
		private function loadInterpersonals()
        {
            $loInterpersonalCollection = new \Presenters\Collections\Interpersonal();

            $loInterpersonalCollection->sortByLevel();

            $this->ioViewController->assign('interpersonals', $loInterpersonalCollection->all());
        }
